...
<html>
	...
	<title>Java Integration Kit Sample Not Found Page</title>
    ...
    <div class="body-container">
        <div id="" class="ping-body-container">
            <div class="header-block">
                <div class="header">IdP Not Found Error</div>
            </div>
            <div class="error-container">
                The resource you requested could not be found. Please return with this link:<div style="text-align: center;"><a href="/IdpSample/MainPage">IdP Sample Application</a></div>
            </div>
        </div>
