    ...
    <div class="body-container">
        <div id="" class="ping-body-container">
            <div class="header-block">
                <div class="header">IdP Error</div>
            </div>
            <div class="error-container">
                There was an error in the IdP Sample Application. Please return with this link:<div style="text-align: center;"><a href="/IdpSample/MainPage">IdP Sample Application</a></div>
            </div>
        </div>
