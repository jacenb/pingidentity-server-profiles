    ...
    <div class="body-container">
        <div id="" class="ping-body-container">
            <div class="header-block">
                <div class="header">IdP Configuration Error</div>
            </div>
            <div class="error-container">
                There was an error in the IdP Application's configuration.  Please return with this link:<div style="text-align: center;"><a href="/IdpSample/MainPage?cmd=configOptions">IdP Application Configuration</a></div>
            </div>
        </div>
