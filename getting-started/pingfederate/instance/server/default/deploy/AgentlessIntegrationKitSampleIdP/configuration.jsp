...
private final static String  REFID_INSTANCE_ID = "IDPREFID";
...
private final static String PARTNER_ENTITY_ID = "SP:REFID";
...
private final static Map<String,Map<String,String>> USERS = 
	...
	{{
		put("john",  new HashMap<String,String>(){{ put("name", "John Brown"); put("status", "Silver"); put("groups", "Users,Developers");}});
	  	put("peter", new HashMap<String,String>(){{ put("name", "Peter Tester"); put("status", "Bronze"); put("groups", "Admins,Network Admins");}});
	  	put("mary",  new HashMap<String,String>(){{ put("name", "Mary White"); put("status", "Gold"); put("groups", "User,Customer");}});
	}};
%>
